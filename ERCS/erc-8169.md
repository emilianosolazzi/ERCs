...
Test files are provided in the reference implementation assets:
- [Full test suite](../assets/erc-8169/test/ERC721H_Full.t.sol) — Core Layer 1/2/3, burn, ERC-165, pagination
- [Analytics test suite](../assets/erc-8169/test/ERC721H_FullTest.t.sol) — Analytics extension, provenance, early adopter
- [Gas benchmark tests](../assets/erc-8169/test/ERC721H_Gas.t.sol) — Gas benchmarks vs baseline ERC-721
- [Sybil guard tests](../assets/erc-8169/test/ERC721H_Sybil.t.sol) — Intra-TX and inter-TX Sybil guards
- [Economic fuzz tests](../assets/erc-8169/test/ERC721H_EconomicFuzz.t.sol) — Fuzz testing and economic attack scenarios

## Reference Implementation

A complete reference implementation is provided in:
- [ERC-721H.sol](../assets/erc-8169/ERC-721H.sol) — Core contract (v2.0.0)
- [IERC-721H.sol](../assets/erc-8169/IERC-721H.sol) — Core interface (10 functions, 3 events) + optional analytics interface (12 functions)
- [ERC-721HStorageLib.sol](../assets/erc-8169/ERC-721HStorageLib.sol) — Low-level storage library
- [ERC-721HCoreLib.sol](../assets/erc-8169/ERC-721HCoreLib.sol) — High-level query library
- [ERC-721HFactory.sol](../assets/erc-8169/ERC-721HFactory.sol) — Production factory + collection wrapper (companion, not required for EIP compliance)
